...
def create_registry_v2(
    service_account_json, project_id, cloud_region, pubsub_topic, registry_id, event_notification_configs
):
    """Creates a registry with PubSub subfolder and returns the result. Returns an empty result if
    the registry already exists."""
    # [START iot_create_registry]
    # project_id = 'YOUR_PROJECT_ID'
    # cloud_region = 'us-central1'
    # pubsub_topic = 'your-pubsub-topic'
    # registry_id = 'your-registry-id'
    # event_notification_configs = 'pubsub_subfolder_list'
    ...
    if not event_notification_configs:
        event_notification_configs = [{"pubsub_topic_name": pubsub_topic}]
